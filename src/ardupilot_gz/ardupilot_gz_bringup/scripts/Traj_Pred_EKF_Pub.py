...
class RelativePoseEKF(Node):
    def __init__(self):
        ...
        # --- SUBSCRIBERS ---
        self.imu_sub = self.create_subscription(Imu, '/imu', self.imu_cb, 10) # coming from UAV
        self.odom_sub = self.create_subscription(Odometry, '/odometry', self.odom_cb, 10) #coming from UGV
    ...
    # -------------------------
    #Your trajectory is being generated in the UAV frame (A-frame) — specifically, 
    # the relative pose of the UGV expressed in the UAV coordinate frame.
